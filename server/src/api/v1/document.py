...
async def upload_document(
    ...
    return success_response(data=result, message="Document uploaded successfully", request_id=request_id)
...
async def delete_document(request: Request, document_id: str) -> dict[str, Any]:
    ...
    return success_response(message="Document deleted successfully", request_id=request_id)